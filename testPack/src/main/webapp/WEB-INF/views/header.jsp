...
<body>
	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			<a class="navbar-brand" href='<c:url value="/home"></c:url>'><img src="<c:url value="/resources/imageProject/niit.jpg"/>"
			...
			<li class="dropdown"><a href="" class="dropdown-toggle"
				...
				<ul class="dropdown-menu">
					<c:forEach items="${list}" var="c">
						<li><a href='<c:url value="/showProductsByCategory/${c.categoryId}"></c:url>'> <span style="font-weight:bold">${c.categoryName}</span> </a></li>
					</c:forEach>
