package com.niit.testPack.controller;
...
import com.niit.testPack.dao.CartItemsDao;
import com.niit.testPack.dao.OrderDetailsDao;
import com.niit.testPack.dao.ProductDao;
import com.niit.testPack.dao.UsersDao;
import com.niit.testPack.model.Cart;
...
//added /cart/
	...
	public ModelAndView addToCart(@PathVariable String id, Principal principal,@RequestParam int requestedQuantity,HttpSession session) {
		...
		while (itr.hasNext()) {
			...
			if (citem.getProduct().getProductId().equals(id) && citem.getCart().getCartId().equals(cid) && citem.isStatus()) {
	...
	public ModelAndView delete(@PathVariable String id,HttpSession session,Principal userPrincipal) {
