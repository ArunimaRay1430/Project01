...
public class ProductController {
	...
	public String getUpdateProductForm(@PathVariable String id,Model model){
		Product product=productDao.getProductById(id);
		List<Category> categories=categoryDao.getAllCategory();
	 ...
	 @RequestMapping(value="/admin/saveProduct",method = RequestMethod.POST)  
	    public String saveProd(@Valid @ModelAttribute("product") Product product,BindingResult result,Model model,HttpServletRequest request)
	    {
